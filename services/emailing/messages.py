...
MESSAGES = {
    "fr": {
        ...
        "footer_no_reply": "Ne répondez pas directement à ce courriel.",
        ...
        "push_title": "Oublie pas !",
        "push_test": "Les rappels arriveront ici.",
        "push_notice_one": "{title} arrive dans {days} jours.",
        "push_notice_many": "{count} échéances arrivent bientôt.",
        "push_overdue_one": "{title} est en retard.",
        "push_overdue_many": "{count} échéances sont en retard.",
        "push_action_required_one": "{title} demande une décision.",
        "push_action_required_many": "{count} lignes demandent une décision.",
        "open_app": "Ouvrir OubliePas",

        "verify_subject": "Vérification de votre adresse",
        "verify_title": "Bienvenue sur OubliePas",
        "verify_intro": "Utilisez ce code pour confirmer votre adresse et terminer votre inscription.",
        "code_expires": "Ce code expire dans 15 minutes.",
        "verify_ignore": "Si vous n'avez pas créé de compte, ignorez ce message.",

        "reset_subject": "Réinitialisation du mot de passe",
        "reset_title": "Nouveau mot de passe",
        "reset_intro": "Utilisez ce code pour choisir un nouveau mot de passe.",
        "reset_ignore": "Si vous n'avez rien demandé, ignorez ce message.",
        ...
        "notice_intro_many": "Voici vos prochaines échéances :",
        ...
        "action_subject_trial": "Votre essai {title} se termine {when}",
        ...
        "trial_detail": "Sans action de votre part, le prélèvement de {amount} commence le {date}.",
        "cancel_headline": "Renouvellement le {date} pour {amount}",
        "cancel_detail": "Pour annuler, vous devez aviser avant le {date}.",
    ...
    "en": {
        ...
        "push_title": "Don't forget!",
        "push_test": "Reminders will land here.",
        "push_notice_one": "{title} is due in {days} days.",
        "push_notice_many": "{count} instalments are coming up.",
        "push_overdue_one": "{title} is overdue.",
        "push_overdue_many": "{count} instalments are overdue.",
        "push_action_required_one": "{title} needs a decision.",
        "push_action_required_many": "{count} lines need a decision.",
